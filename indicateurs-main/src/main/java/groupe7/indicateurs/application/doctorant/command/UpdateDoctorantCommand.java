...
public class UpdateDoctorantCommand extends DoctorantCommand {
    ...
    public UpdateDoctorantCommand(String nom, String prenom, Boolean hdr, String statut, String equipe, Boolean titulaire, LocalDate date_debut, LocalDate date_fin, Long id_encadrant, LocalDate date_soutenance, List<ProjetDTO> projets,List<ArticleDTO> articles) {
