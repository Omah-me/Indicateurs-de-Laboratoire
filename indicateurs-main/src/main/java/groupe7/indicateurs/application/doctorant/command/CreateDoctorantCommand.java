...
public class CreateDoctorantCommand extends DoctorantCommand {
    ...
    public CreateDoctorantCommand(String nom, String prenom, Boolean hdr, String statut, String equipe, Boolean titulaire, LocalDate date_debut, LocalDate date_fin, Long id_encadrant, LocalDate date_soutenance, List<ProjetDTO> projets,List<ArticleDTO> articles) {
        ...
        this.id_encadrant = Objects.requireNonNull(id_encadrant, "L'id de l'encadrant est obligatoire");
