...
public class Doctorant {
    ...
    public Doctorant(LocalDate date_soutenance, Long id_encadrant, Personnel personnel) {
    ...
    public void setIdEncadrant(Long id_encadrant) {
        this.id_encadrant = id_encadrant;
    }
